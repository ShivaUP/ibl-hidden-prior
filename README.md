...
Config: [`configs/synthetic_v2.yaml`](configs/synthetic_v2.yaml). Outputs: `artifacts/v2/`, `reports/v2/`.

### Figure catalog (v2)

| Path | What it answers | Regenerated by |
|---|---|---|
| `reports/v2/figures/by_model/{model}/multipanel_diagnostics.png` | Train curve, psychometric-by-block, switch zero-contrast belief, session prior vs belief | `10_make_figures.py` |
| `reports/v2/figures/comparison/synth_heldout_accuracy.png` | Primary synth ranking | same |
